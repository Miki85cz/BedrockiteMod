package com.miki.bedrockbreaker;
...
import com.miki.bedrockbreaker.init.BedrockBreakerModTabs;
...
@Mod("bedrockbreaker")
public class BedrockBreakerMod {
	public static final Logger LOGGER = LogManager.getLogger(BedrockBreakerMod.class);
